...
*/			
	 	...
	 	asprintf(&s, "date 0101%02d%02d2009; hwclock --systohc", h, m);
		system(s);
		if(s)
			free(s);
		exit(0);
...
//	ewl_theme_data_str_set(EWL_WIDGET(label), "/label/group", "ewl/label/dlg_valuelabel");
//	ewl_theme_data_str_set(EWL_WIDGET(label), "/label/textpart", "ewl/label/dlg_valuelabel/text");
